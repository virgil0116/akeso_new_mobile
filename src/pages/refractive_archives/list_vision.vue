    ...
    <div class="container">
      ...
      <ul class="list">
        <li>
          ...
          <selector :options="degreesList" v-model="value1" dir="rtl" title="" class="input-group-lg" />
        </li>
        <li>
          <span class="left-bar">戴镜远视力</span>
          <selector :options="degreesList" v-model="value2" dir="rtl" title="" class="input-group-lg" />
        </li>
        <li>
